...
CREATE TABLE `dependent` (
  ...
  KEY `ESSN_idx` (`ESSN`),
  CONSTRAINT `ESSN` FOREIGN KEY (`ESSN`) REFERENCES `employee` (`SSN`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `employee` (
  ...
  CONSTRAINT `DNO` FOREIGN KEY (`DNO`) REFERENCES `departments` (`Dnum`) ON DELETE NO ACTION ON UPDATE NO ACTION,
...
-- Dump completed on 2015-11-23 21:19:00
